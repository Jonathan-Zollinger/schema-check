...
public class Alert {
    ...
    public void setEmailAlertingEnabled(boolean emailAlertingEnabled) {
        this.isEmailAlertingEnabled = emailAlertingEnabled;
    }
    ...
    public void setLogAlertingEnabled(boolean logAlertingEnabled) {
        this.isLogAlertingEnabled = logAlertingEnabled;
    }
}
